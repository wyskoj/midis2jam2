...
class OnScreenElementsSettings(private val settings: Settings) {
    ...
    private var _isShowHeadsUpDisplay =
        MutableStateFlow(settings.getBoolean(SettingsKeys.OnScreenElements.IS_SHOW_HEADS_UP_DISPLAY, SettingsDefaults.OnScreenElements.IS_SHOW_HEADS_UP_DISPLAY))
