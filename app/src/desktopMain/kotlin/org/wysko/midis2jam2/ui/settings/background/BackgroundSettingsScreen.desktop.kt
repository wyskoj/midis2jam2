...
import midis2jam2.app.generated.resources.settings_background_type_cubemap_repeated
import midis2jam2.app.generated.resources.settings_background_type_cubemap_repeated_description
import midis2jam2.app.generated.resources.settings_background_type_cubemap_unique
import midis2jam2.app.generated.resources.settings_background_type_cubemap_unique_description
...
internal actual val backgroundTypeOptions: List<SettingsOption<AppSettings.BackgroundSettings.BackgroundType>>
    ...
    get() = listOf(
        ...
        SettingsOption(
            value = AppSettings.BackgroundSettings.BackgroundType.RepeatedCubeMap,
            title = stringResource(Res.string.settings_background_type_cubemap_repeated),
            label = stringResource(Res.string.settings_background_type_cubemap_repeated_description),
            icon = { BackgroundTypeIcon(AppSettings.BackgroundSettings.BackgroundType.RepeatedCubeMap) }
        ),
        SettingsOption(
            value = AppSettings.BackgroundSettings.BackgroundType.UniqueCubeMap,
            title = stringResource(Res.string.settings_background_type_cubemap_unique),
            label = stringResource(Res.string.settings_background_type_cubemap_unique_description),
            icon = { BackgroundTypeIcon(AppSettings.BackgroundSettings.BackgroundType.UniqueCubeMap) }
        ),
        SettingsOption(
