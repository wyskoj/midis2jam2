...
object QueueTab : Tab {
    ...
    override fun Content() {
        ...
        val queueSavePicker = model.queueSavePicker { (file) ->
            scope.launch {
                file.writeText(queue.value.joinToString("\n") { it.file.absolutePath })
        ...
        fun saveQueue() {
            queueSavePicker.launch(suggestedName = "queue.txt", defaultExtension = "txt")
        }
