...
object SettingsCategoryCardDefaults {
    val baseShape: CornerBasedShape
        @Composable
        get() = CardDefaults.shape as CornerBasedShape

    @Composable
    fun itemShape(index: Int, count: Int, baseShape: CornerBasedShape = SettingsCategoryCardDefaults.baseShape): Shape {
