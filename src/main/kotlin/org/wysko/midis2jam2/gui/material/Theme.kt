...
@file:Suppress("DuplicatedCode", "unused", "KDocMissingDocumentation")
...
val extendedLight: ExtendedColorScheme = ExtendedColorScheme(
...
val extendedDark: ExtendedColorScheme = ExtendedColorScheme(
    customColor = ColorFamily(
        customColorDark,
        onCustomColorDark,
...
val extendedLightMediumContrast: ExtendedColorScheme = ExtendedColorScheme(
    customColor = ColorFamily(
...
val extendedLightHighContrast: ExtendedColorScheme = ExtendedColorScheme(
    customColor = ColorFamily(
...
val extendedDarkMediumContrast: ExtendedColorScheme = ExtendedColorScheme(
    customColor = ColorFamily(
...
val extendedDarkHighContrast: ExtendedColorScheme = ExtendedColorScheme(
    customColor = ColorFamily(
...
/**
 * A composable that provides the theme for the app.
 */
@Composable
fun AppTheme(
