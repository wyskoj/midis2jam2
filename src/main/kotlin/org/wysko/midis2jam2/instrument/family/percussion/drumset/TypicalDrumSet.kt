...
class TypicalDrumSet(
    ...
    private val instruments =
        buildList {
            this += BassDrum(context, events.filterByNotes(35, 36).toMutableList(), typicalDrumSetSkin)
            this += SnareDrum(context, events.filterByNotes(37, 38, 40).toMutableList(), typicalDrumSetSkin)
            this += HiHat(context, events.filterByNotes(42, 44, 46).toMutableList())
            this += Tom(context, events.filterByNotes(41).toMutableList(), TomPitch["low_floor"], typicalDrumSetSkin)
            this += Tom(context, events.filterByNotes(43).toMutableList(), TomPitch["high_floor"], typicalDrumSetSkin)
            this += Tom(context, events.filterByNotes(45).toMutableList(), TomPitch["low"], typicalDrumSetSkin)
            this += Tom(context, events.filterByNotes(47).toMutableList(), TomPitch["low_mid"], typicalDrumSetSkin)
            this += Tom(context, events.filterByNotes(48).toMutableList(), TomPitch["high_mid"], typicalDrumSetSkin)
            this += Tom(context, events.filterByNotes(50).toMutableList(), TomPitch["high"], typicalDrumSetSkin)
