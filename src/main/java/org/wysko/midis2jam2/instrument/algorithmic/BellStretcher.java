 ...
 */
public interface BellStretcher {
	 ...
	 */
	void tick(double stretchAmount);
	
	/**
	 * Sets the amount of bell stretch from the current {@link NotePeriod}. You should call this method on every frame.
	 *
	 * @param period the note period from which to calculate the amount to stretch the bell by
	 */
	void tick(NotePeriod period, double time);
}
