 ...
 * <p>
 * The fretting algorithm attempts to use a running average of the last used frets to avoid drifting across the
...
public class FrettingEngine {
	 ...
	 *                            the highest string)
	 */
	public FrettingEngine(int numberOfStrings, int numberOfFrets, int[] openStringMidiNotes, int rangeLow,
	                      int rangeHigh) {
	 ...
	 */
	public static class FretboardPosition {
