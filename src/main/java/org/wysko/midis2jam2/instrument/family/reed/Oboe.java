...
public class Oboe extends HandedInstrument {
	 ...
	 */
	public Oboe(@NotNull Midis2jam2 context, @NotNull List<MidiChannelSpecificEvent> eventList)
		...
		super(context,
				...
				Stream.concat(
						eventList.stream()
								...
								.filter(note -> note.getNote() >= 58 && note.getNote() <= 90),
						eventList.stream()
	 ...
	 * The type Oboe clone.
	 */
	public class OboeClone extends HandedClone {
		...
		/**
		 * Instantiates a new oboe clone.
		 */
		public OboeClone() {
			super(Oboe.this, 0.075F);
			
			/* Load body */
			modelNode.attachChild(context.loadModel("OboeBody.fbx", "OboeSkin.png"));
			
			/* Load bell */
			Spatial bell = context.loadModel("OboeHorn.fbx", "OboeSkin.png");
