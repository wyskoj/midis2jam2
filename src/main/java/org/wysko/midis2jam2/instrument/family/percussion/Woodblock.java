...
public class Woodblock extends NonDrumSetPercussion {
	...
	public void tick(double time, float delta) {
		...
		Stick.StickStatus statusLow = Stick.handleStick(context, rightStickNode, time, delta, leftHits, Stick.STRIKE_SPEED, Stick.MAX_ANGLE);
		Stick.StickStatus statusHigh = Stick.handleStick(context, leftStickNode, time, delta, rightHits, Stick.STRIKE_SPEED, Stick.MAX_ANGLE);
